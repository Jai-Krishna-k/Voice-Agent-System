  ...
  return (
    <div className="px-10 py-8 space-y-6 max-w-6xl">
      <div className="flex items-center gap-3">
        <Link
          href="/calls"
          className="p-1.5 rounded-sm hover:bg-[#0F0F0F] transition-colors"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-card border border-card-border rounded-sm p-5 space-y-4">
            <h2 className="text-sm font-medium text-stone-300">Call Info</h2>
            {fetchError || !call ? (
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-stone-300 capitalize">{call.status}</span>
                </div>
                <div className="flex justify-between">
          ...
          <div className="bg-card border border-card-border rounded-sm p-5 space-y-3">
            <h2 className="text-sm font-medium text-stone-300">Recording</h2>
            {call?.recording_url ? (
        ...
        <div className="lg:col-span-2">
          <div className="bg-card border border-card-border rounded-sm p-5">
            <h2 className="text-sm font-medium text-stone-300 mb-4">
              Transcript
            </h2>

            {transcripts.length === 0 ? (
              <div className="text-center py-16">
                <Phone className="w-8 h-8 text-stone-700 mx-auto mb-3" />
