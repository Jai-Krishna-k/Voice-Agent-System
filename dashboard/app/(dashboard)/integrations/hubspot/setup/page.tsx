...
function HubSpotSetup() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      <Link
        href="/integrations"
        className="flex items-center gap-2 text-sm text-stone-400 hover:text-zinc-200 mb-6"
      >
      ...
      {step === "token" && (
        <div className="space-y-5 max-w-xl">
            ...
            <ol className="list-decimal pl-5 space-y-1.5 text-stone-400">
              ...
              <li>
                ...
                <ul className="list-disc pl-5 mt-1 space-y-0.5">
                  <li><code className="text-xs text-stone-300">crm.objects.contacts.read</code></li>
                  <li><code className="text-xs text-stone-300">crm.objects.contacts.write</code></li>
                  <li><code className="text-xs text-stone-300">crm.objects.notes.write</code></li>
                </ul>
              </li>
          ...
          <div>
            <label className="text-xs text-stone-400 mb-1.5 block">Private App token</label>
            <input
